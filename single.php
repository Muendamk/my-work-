...
if (isset($_GET['id'])){
    $post = selectOne('album_songs', ['album_id' => $_GET['id']]);

}
//$artists = selectAll('artists');
$album_songs = selectAll('album_songs');
//$instrumentals = selectAll('posts', ['published' => 1]);
//$query = "SELECT * FROM posts where id= $_SESSION['id']";
$query = "SELECT * FROM album_songs WHERE album_id = $post[id] ";
//$query = "SELECT * FROM posts WHERE id = $_SESSION[id]";
...
$query = "SELECT * FROM counter_table WHERE post_id ='$id' ";
...
if ($total_visitors<1){
    //$query = "INSERT INTO counter_table(post_id) VALUES ( '$id')";
...
$sql="SELECT * FROM album_songs WHERE album_id='$id'";
$result = mysqli_query($conn, $sql);
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			...
			<div class="header-top-right">
				...
				<div class="signin">
					<a href="#" class="play-icon popup-with-zoom-anim">Account</a>
					<!-- pop-up-box -->
									...
									<div id="small-dialog4" class="mfp-hide">
										...
										<div class="feedback-grids">
											<div class="feedback-grid">
												<p>Leave us a feedback, so that we can continue to make this site more freindly and ore fun to use.</p>
											</div>
											<div class="button-bottom">
									...
									<div id="small-dialog5" class="mfp-hide">
										<h3>Help</h3> 
											...
											<div class="help-grids">
												...
												<div class="help-button-bottom">
													<p><a href="#small-dialog6" class="play-icon popup-with-zoom-anim">Can't create an account</a></p>
												</div>
												<div class="help-button-bottom">
													<p><a href="#small-dialog6" class="play-icon popup-with-zoom-anim">can't create my playlist</a></p>
												</div>
												<div class="help-button-bottom">
													<p><a href="#small-dialog6" class="play-icon popup-with-zoom-anim">Can't find my favorite songs</a></p>
												</div>
												<div class="help-button-bottom">
													<p><a href="#small-dialog6" class="play-icon popup-with-zoom-anim">how to upload</a></p>
												</div>
												<div class="help-button-bottom">
													<p><a href="#small-dialog6" class="play-icon popup-with-zoom-anim">how to delete an account</a></p>
												</div>
											</div>
									</div>
									<script>
				...
				<div class="signin">
					<a href="#small-dialog" class="play-icon popup-with-zoom-anim">Sign Out</a>
		...
		<div class="top-navigation">
			...
			<div class="drop-navigation drop-navigation">
			  <ul class="nav nav-sidebar">
				...
				<li><a href="shows.html" class="user-icon"><span class="glyphicon glyphicon-home glyphicon-blackboard" aria-hidden="true"></span>Podcast & Radio</a></li>
				...
				<li><a href="#" class="menu1"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Genre<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					<ul class="cl-effect-2">
						...
						<li><a href="movies.html">House</a></li>
						<li><a href="movies.html">Amapiano</a></li> 
						<li><a href="movies.html">Afro Pop</a></li> 
					</ul>
					<!-- script-for-menu -->
					<script>
				...
				<li><a href="#" class="menu"><span class="glyphicon glyphicon-film glyphicon-king" aria-hidden="true"></span>Moods<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					<ul class="cl-effect-1">
						<li><a href="sports.html">Happy</a></li>                                             
						<li><a href="sports.html">Sad</a></li>
						<li><a href="sports.html">Alone</a></li> 
						<li><a href="sports.html">Turn Up</a></li>  
					</ul>
					<!-- script-for-menu -->
					<script>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
				...
				<div class="col-md-4 single-right">
					...
					<?php foreach($posts as $p):?>
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="single.html"><img src="<?php echo 'admin/albums/poster/' . $p['image']; ?>" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="single.html" class="title"> <?php echo $p['name'];?></a>
								<p class="author"><a href="#" class="author">Song Artist</a></p>
								<p class="views"> Listeners</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<?php endforeach?>
					<!--	<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								<a href="single.html"><img src="images/up next.jpg" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
								<a href="single.html" class="title"> song name</a>
								<p class="author"><a href="#" class="author">Song Artist</a></p>
								<p class="views"> Listeners</p>
							</div>
							<div class="clearfix"> </div>

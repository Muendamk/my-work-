...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
   ...
   <link rel="stylesheet" href="../admin/posts/admin.css">
 ...
 <body>
   ...
   <div class="content clearfix">
     ...
     <div class="main-content">
       ...
       <a href="../playlists.php"class="btn btn-big">Manage Playlists</a>
     </div><br><br>
     ...
     <form class="" action="create.php" method="post" enctype="multipart/form-data">
         <div>
           ...
           <input type="text" name="title"  placeholder="Title" class="text-input" value="<?php echo $title  ?>">
             ...
             <div><div><br>
             <button type="submit" name="playlist-btn" class="btn btn-big">Create Playlist</button>
                 </div>
     </form>
     </div>
   </div>

...
<link href="https://fonts.googleapis.com/css2?family=Candal&family=Lora&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="content clearfix">
      ...
      <form class="" action="create-post.php" method="post" enctype="multipart/form-data">
          <div>

            <input type="text" name="title"  placeholder="Title" class="text-input" value="<?php echo $title  ?>">
          </div>

          <div>
          <label ></label>
          <textarea  name="body"  placeholder="Body...." id="body"><?php echo $body ?></textarea>
            </div>
          <div>
  ...
  Select Folder to Upload: <input type="file" name="files[]" id="files" multiple directory="" webkitdirectory="" moxdirectory="" /><br/><br/> -->
          ...
          <!--  <label>Vid</label>
            <input type="file" name="song"  class="text-input">
            <label></label>-->
            <select name="genre_id" class="text-input" >
                <option>--Choose Genre--</option>

              <?php foreach ($genres as $key => $genre): ?>
                <?php if (!empty($genre['id']) && $genre_id == $genre['id'] ): ?>
...
<script src="https://cdn.ckeditor.com/ckeditor5/22.0.0/classic/ckeditor.js"></script>
  ...
  <?php
    if (isset($_POST['add-post'])){
      ...
      $sql = "INSERT INTO videos ( video) VALUES ('$name')";

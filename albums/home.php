...
<br><br>
    ...
    <div class="admin-content">
       ...
       <!--   <a href="index.php" class="btn btn-big">Upload Songs</a>
          <a href="folder.php" class="btn btn-big">Upload Folder</a>-->
          <a href="beats.php" class="btn btn-big">Upload Beats</a>
        </div>
    <div class="content clearfix">
      ...
      <div class="main-content">
        ...
        <div class="content">
          <h2 class="page-title">Manage  your Beats<br>  <?php echo $_SESSION['username'];  ?></h2>
        ...
        <?php
        $instrumentals = selectAll($table,['user_id'=>$curr_user]);
        foreach ($instrumentals as $key => $post):
         ...
         foreach ($instrumentals as $key => $post): ?>
                ...
                <tr>
                  ...
                  <!--<td><?php echo $_SESSION['username']; ?></td>-->
                      ...
                      <td> <a href="editing.php?id=<?php echo $post['id']; ?>" class="edit" >edit</a></td>
                        <td> <a href="editing.php?delete_id=<?php echo $post['id']; ?>" class="delete" >delete</a></td>


                <?php if ($post['published']): ?>
                  <td> <a href="editing.php?published=0&p_id=<?php echo $post['id'] ?>" class="unpublish" >unpublish</a> </td>
                <?php else: ?>
                  <td> <a href="editing.php?published=1&p_id=<?php echo $post['id'] ?>" class="publish" >publish</a> </td>
                <?php endif; ?>
              </tr>
            <?php endforeach; ?>
            </tbody>

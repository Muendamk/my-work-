...
<br><br><br>
              ...
              <form action="add.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                  <div>
                  <h1> <a href="process.php">View Posted videos</a> </h1><br><br>
      <form class="" action="index.php" method="post" enctype="multipart/form-data">
          <div>

        <!--    <input type="text" name="title"  placeholder="Title" class="text-input" >
          </div>
      ...
      <!--     <label>Video Cover</label>
            <input type="file" name="file"  class="text-input">
              ...
              <div><div><br> -->
                <label>Video</label>
                <input type="file" name="file" value="audio/" class="text-input">

                  <div><div><br>
              <button type="submit" name="update-post" class="btn btn-danger btn-block btn-lg col-md-4 offset-md-4 form-div">Post</button>
                  </div>
      </form>
      </div>
    </div>
                   ...
                   <!--   <button type="submit" name="update-pos" class="btn btn-big">Update Post</button>-->
                          </div>
              </form>
              </div>
          </div>
        ...
        if (isset($_POST['update-pos'])){
          ...
          move_uploaded_file($tmp, "../../videos/posts/".$name);


          $sql = "UPDATE posts SET path='$name'";
  ...
  <form action="details.php" method="post">
    <input type="text" name="search-term" id="search" class="text-input" placeholder="Search....">
  </form>
  <div class="col-md-5" style="position:relative;margin-top:0px;margin-left:0px;">

<?php
session_start();
$con = mysqli_connect('localhost', 'root', '', 'music_storage');
...
//  $name= $_POST['name'];
  ...
  {
    $foldername=$_POST['foldername'];
    if(!is_dir($foldername)) mkdir($foldername, 777,true);
 ...
 $iosql = "INSERT INTO albums (album_id,title,uid,image) VALUES ('$token', '$foldername', '$uid','$image')";
				$iores = mysqli_query($con, $iosql) or die(mysqli_error($con));
			

						$orditmsql ="INSERT INTO album_songs (album_id,name,fname,uid,image) VALUES ('$token','$name', '$foldername', '$uid','$image')";
...
<link href="https://fonts.googleapis.com/css2?family=Candal&family=Lora&display=swap" rel="stylesheet">
 ...
 <body>
   ...
   <div class="content clearfix">
     ...
     <form class="" action="folder.php" method="post" enctype="multipart/form-data">
         <div>

         Type Folder Name:<input type=""  name="foldername" /><br/><br/>
  <input type="hidden" value="<?php echo $_SESSION['id'];?>" name="uid" >

         cover::  <input type="file" name="image"><br>
  Select Folder to Upload: <input type="file" name="files[]" id="files" multiple directory="" webkitdirectory="" moxdirectory=""webkitRelativePath="" /><br/><br/> 

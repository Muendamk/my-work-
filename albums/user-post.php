...
<link href="https://fonts.googleapis.com/css2?family=Candal&family=Lora&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <a href="user.php"class="btn btn-big">Manage Posts</a>
      </div><br><br>

      <div class="content">
        <h2 class="page-title">Whats on your mind   <?php echo $_SESSION['username']; ?>? </h2><br>
                            <?php include 'flash-messages.php'; ?>
      <form class="" action="user-post.php" method="post" enctype="multipart/form-data">
          <div>
